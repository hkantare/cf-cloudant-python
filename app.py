...
target.truncate()
target.write("<html><head><title>Cloudant Python Demo</title></head><body><p>Log of Cloudant NoSQL DB Python steps...</p><pre>")
...
# Start working with the Cloudant NoSQL DB service instance.
...
if 'VCAP_SERVICES' in os.environ:
    ...
    # Log the fact that we successfully found the Cloudant NoSQL DB values.
